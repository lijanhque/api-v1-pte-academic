...
exports.ensureUvInstalled = void 0;
...
const ensureUvInstalled = async () => {
    if (!(await checkCommand('uv', ['--version']))) {
        if (await installUv()) {
            ...
            throw new Error('UV could not be installed automatically. Please install manually using one of these methods:\n' +
...
exports.ensureUvInstalled = ensureUvInstalled;
