...
const cron_expressions_validator_1 = require("../cron-expressions.validator");
describe('cronExpressionsValidator', () => {
    ...
    const createMockCronStep = (name, filePath, cronExpression) => ({
        type: 'node',
        entrypointPath: filePath,
        config: { name, type: 'cron', cron: cronExpression },
        filePath,
    });
    it('should return no errors for valid cron expressions', () => {
        ...
        const result = (0, cron_expressions_validator_1.cronExpressionsValidator)(builder);
