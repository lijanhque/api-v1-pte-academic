...
const step_name_lengths_validator_1 = require("../step-name-lengths.validator");
describe('stepNameLengthsValidator', () => {
    ...
    it('should return no errors when step names are within length limit', () => {
        ...
        const result = (0, step_name_lengths_validator_1.stepNameLengthsValidator)(builder);
        expect(result.errors).toHaveLength(0);
        expect(result.warnings).toHaveLength(0);
    });
    it('should return error when step name exceeds length limit', () => {
        const longName = 'a'.repeat(constants_1.BUNDLE_SIZE_LIMITS.STEP_NAME_MAX_LENGTH + 1);
        const builder = createMockBuilder({
    ...
    it('should accept step name exactly at the limit', () => {
        const exactLengthName = 'a'.repeat(constants_1.BUNDLE_SIZE_LIMITS.STEP_NAME_MAX_LENGTH);
        const builder = createMockBuilder({
    ...
    it('should return multiple errors for multiple long names', () => {
        const longName1 = 'a'.repeat(constants_1.BUNDLE_SIZE_LIMITS.STEP_NAME_MAX_LENGTH + 1);
        const longName2 = 'b'.repeat(constants_1.BUNDLE_SIZE_LIMITS.STEP_NAME_MAX_LENGTH + 5);
        const builder = createMockBuilder({
