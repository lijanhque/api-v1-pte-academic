...
const build_validation_1 = require("../build-validation");
describe('Infrastructure Validation in Build Process', () => {
    function createMockBuilder(stepsConfig) {
        return {
            stepsConfig,
    ...
    function createMockStep(name, configType, infrastructure, input) {
        return {
            type: 'node',
    ...
    describe('Valid Infrastructure Configurations', () => {
        it('should accept valid handler configuration', () => {
            ...
            const { errors } = (0, build_validation_1.validateStepsConfig)(builder);
    ...
    describe('Queue Config on Non-Event Steps', () => {
        it('should not warn when queue config is present on Event step', () => {
            ...
            const builder = createMockBuilder({ testStep: step });
            const { warnings } = (0, build_validation_1.validateStepsConfig)(builder);
    ...
    describe('Build Validation Edge Cases', () => {
        ...
        it('should ignore infrastructure config on API steps', () => {
            ...
            const { errors, warnings } = (0, build_validation_1.validateStepsConfig)(builder);
            expect(errors).toHaveLength(0);
        ...
        it('should handle multiple validation errors for single step', () => {
            ...
            const step = createMockStep('multiErrorStep', 'event', {
                handler: {
                    ram: 64,
                    timeout: 1000,
                    cpu: 10,
