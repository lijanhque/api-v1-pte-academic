...
exports.DeploymentStreamManager = exports.createDefaultDeploymentData = void 0;
...
class DeploymentStreamManager {
    ...
    async updateDeployment(deploymentId, data) {
        ...
        if (!current) {
            await this.stream.set(deploymentId, 'data', {
                ...(0, exports.createDefaultDeploymentData)(deploymentId),
                ...data,
                id: deploymentId,
            });
        }
    ...
    async startDeployment(deploymentId) {
        const defaultData = (0, exports.createDefaultDeploymentData)(deploymentId);
        await this.stream.set(deploymentId, 'data', {
            ...defaultData,
            status: 'building',
            phase: 'build',
...
exports.DeploymentStreamManager = DeploymentStreamManager;
