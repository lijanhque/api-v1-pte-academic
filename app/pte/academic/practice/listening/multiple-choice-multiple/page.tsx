...
async function getQuestions() {
  try {
    const questions = await db
      ...
      .where(eq(listeningQuestions.type, 'multiple_choice_multiple'))
      .limit(100)
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Listen to a recording and select all correct answers
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Select a question to start practicing. More than one answer may be correct.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <QuestionListTable
